...
public:
    ...
    float shininess;
    // ctor/dtor
    Sphere(float radius = 1.50f, int sectorCount = 20, int stackCount = 40, glm::vec3 amb = glm::vec3(1.0f, 1.00f, 1.0f), glm::vec3 diff = glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3 spec = glm::vec3(1.0f, 1.0f, 1.0f),glm::vec3 emission=glm::vec3(1.0f,1.0f,1.0f), float shiny = 1.0f) : verticesStride(24)
    {
